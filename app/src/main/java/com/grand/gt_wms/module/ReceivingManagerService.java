...
/**
 * Created by Administrator on 2018/10/15.收货扫描接口逻辑
 */

public class ReceivingManagerService implements wmsBroadcastReceiver.HalReceivingCallback {
    ...
    public ReceivingManagerService(Context context) {
        ...
        wmsBroadcastReceiver.getInstance().registerHalReceivingCallback(this);
    }
