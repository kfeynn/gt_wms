...
public class JoinAdapter extends MyGroupedRecyclerViewAdapter {
    ...
    public int getHeaderLayout(int viewType) {
        return R.layout.grid_join_boxlist;
    }
    ...
    public void onBindHeaderViewHolder(BaseViewHolder holder, int groupPosition) {
        if(wmsService.whrBoxList != null){
            ...
            holder.setText(R.id.tv_rvv31, "料号："+wmsService.whrBoxList.get(groupPosition).getRvv31());
            holder.setText(R.id.tv_ima02, "品名："+wmsService.whrBoxList.get(groupPosition).getIma02());
            holder.setText(R.id.tv_rvv32, "仓库："+wmsService.whrBoxList.get(groupPosition).getRvv32());
            holder.setText(R.id.tv_rvv17, "仓退总数："+wmsService.whrBoxList.get(groupPosition).getRvv17());
        }
    }
