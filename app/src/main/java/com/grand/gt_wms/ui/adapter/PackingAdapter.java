...
public class PackingAdapter extends MyGroupedRecyclerViewAdapter {
    ...
    public void onBindHeaderViewHolder(BaseViewHolder holder, int groupPosition) {
        if(wmsService.PKBoxList != null){
            ...
            holder.setText(R.id.tv_rvbs06, "此箱发料数量："+wmsService.PKBoxList.get(groupPosition).getRvbs06());
            if(wmsService.PKBoxList.get(groupPosition).getSfp01() != null){
                holder.setText(R.id.tv_sfs04, "料号："+wmsService.PKBoxList.get(groupPosition).getSfs04());
                holder.setText(R.id.tv_sfs05, "发料总数："+wmsService.PKBoxList.get(groupPosition).getSfs05());
            ...
            }else if(wmsService.PKBoxList.get(groupPosition).getInb01() != null){
                holder.setText(R.id.tv_sfs04, "料号："+wmsService.PKBoxList.get(groupPosition).getInb04());
                holder.setText(R.id.tv_sfs05, "发料总数："+wmsService.PKBoxList.get(groupPosition).getInb09());
                holder.setText(R.id.tv_sfs0708, "仓库/储位："+wmsService.PKBoxList.get(groupPosition).getInb05()+"/"
                        +wmsService.PKBoxList.get(groupPosition).getInb06());
            }
