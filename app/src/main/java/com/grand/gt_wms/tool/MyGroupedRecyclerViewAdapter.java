...
import com.grand.gt_wms.ui.groupedadapter.structure.GroupStructure;
...
public abstract class MyGroupedRecyclerViewAdapter extends GroupedRecyclerViewAdapter {
        ...
        if (type == TYPE_HEADER) {
            if (mOnHeaderClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnHeaderClickListener != null) {
                            mOnHeaderClickListener.onHeaderClick(MyGroupedRecyclerViewAdapter.this,
            ...
            if (mOnFooterClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnFooterClickListener != null) {
                            mOnFooterClickListener.onFooterClick(MyGroupedRecyclerViewAdapter.this,
                                    (BaseViewHolder) holder, groupPosition);
                        }
                    }
                });
            ...
            if (mOnChildClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnChildClickListener != null) {
                            mOnChildClickListener.onChildClick(MyGroupedRecyclerViewAdapter.this,
     ...
     * @param listener
     */
    public void setOnFooterClickListener(GroupedRecyclerViewAdapter.OnFooterClickListener listener) {
     ...
     * @param listener
     */
    public void setOnChildClickListener(GroupedRecyclerViewAdapter.OnChildClickListener listener) {
